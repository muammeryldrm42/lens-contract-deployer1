...
function ensureSolc(){
  if (typeof window.solc === 'undefined'){
    throw new Error("Compiler not loaded yet. Use 'Compiler status' panel.");
  }
  return window.solc;
}
...
const ABI_ERC20 = [ {"type":"function","name":"mint","inputs":[{"name":"to","type":"address"},{"name":"amount","type":"uint256"}],"outputs":[],"stateMutability":"nonpayable"} ];
const ABI_ERC721 = [ {"type":"function","name":"mint","inputs":[{"name":"to","type":"address"}],"outputs":[{"type":"uint256"}],"stateMutability":"nonpayable"} ];
